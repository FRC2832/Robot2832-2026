...
public class SpinAndShootWhileReady extends Command {
    ...
    private final double TARGET_SPEED = 80;
    ...
    @Override
    public void execute() {
        double leftSpeed = 0.9;//SpinShooterCommand.leftSpeed.getAsDouble();
        double rightSpeed = 0.9;//SpinShooterCommand.rightSpeed.getAsDouble();
